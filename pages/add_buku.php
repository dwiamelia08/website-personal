                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-5">
                            <!-- Title -->
                            <h1 class="h2 ls-tight">Tambah Buku</h1>
                        </div>
                        <!-- Actions -->
                ...
                <div class="card shadow border-0 mb-7">
                    <form class="px-5 py-5 mt-3 mb-5" action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="penerbit" required placeholder="Masukkan Penerbit">
                        </div>
                        <div class="mb-3">
                            <label for="tahun" class="form-label">Tahun</label>
                            <input type="text" class="form-control" name="tahun" required placeholder="Masukkan Tahun">
                        </div>
                        <div class="mb-3">
                            <label for="tgl_masuk" class="form-label">Tanggal Masuk</label>
                            <input type="date" class="form-control" name="tgl_masuk" required placeholder="Masukkan Tanggal Masuk">
                        </div>
